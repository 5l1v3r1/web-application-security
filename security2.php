...
$rce 	= "wget -O|python|cat \/etc\/|ls -la";
$lfi	= "\.\.\/|\/etc\/passwd";
$global = "indoxploit|backdoor|exploit|priv8|gif89a|cyber team|alfa team|encode|decode|eval\(|system\(|file_get_contents\(|makman|local root|permission|scandir\(|shell";
...
function do_Block($value){
	...
	file_put_contents("attacker.txt", $_SERVER['REMOTE_ADDR']."\n", FILE_APPEND);
